	...
	body(){
		...
		return(
			...
			<div className="divAvatarDetail">
				<img className="avatarDetail" src={'https://eventapp.dexagroup.com/apiget_file?fd='+this.state.image} />
			</div>
			...
			<div className="divListAvatarDetail">
				...
				<ul className="ulAvatarDetailList">
					...
					<li className="ulliAvatarDetailList"><b>Skills :</b> <br/> {this.state.skills}</li>
					<li className="ulliAvatarDetailList"><b>Education :</b> <br/> {this.state.education}</li>
					<li className="ulliAvatarDetailList"><b>Experience :</b> <br/> {this.state.experience}</li>
	...
	render() {
		...
		return (
			...
			<div className="eventBackgroundHeaderIattend">
						<Icon className="eventJudulAgendaIcon" onClick={() => this.onclickBack()}>arrow_back</Icon> <h1 className="eventJudulAgenda">Speaker Detail</h1>
						<div className="break"></div>
			</div>
