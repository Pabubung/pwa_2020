...
import spklapprovalActions from "../../redux/spklApproval/actions";
...
const { SPKLAPPROVAL_LIST_REQUEST, SPKLAPPROVAL_LIST_BUTTONAPPROVAL_REQUEST } = spklapprovalActions;
...
class GitSearch extends Component {
	...
	componentDidMount(){
		...
		if(data !== "undefined"){
		  ...
		  this.props.SPKLAPPROVAL_LIST_REQUEST(
			{
			  "offset":"1",
	...
	handleApprove (value){
		...
		if(data !== "undefined"){
		  ...
		  this.props.SPKLAPPROVAL_LIST_BUTTONAPPROVAL_REQUEST(
			{
			  "workflowId":value,
				"userId":bitrix.result.data.ID,
				"remarks":'tidak ada',
		...
		return(
			...
			this.state.data.map((item, index, key)=>(
				...
				className="eventlist_ul">
					...
					<Typography className="my_approval_leaverequest"><b>{item.DATA.AUTHOR.NAME}</b> has made a request <b>{item.DATA.CONTENT.TEXT.ID_CASE}</b> for SPKL request on {item.DATE}. Please click detail button for more detail Information :</Typography>
					...
					{item.DATA.CONTENT.TEXT_DUA.DETAIL_COUNT !== 0 ? 
						...
						<Button size="small"  color="default" className="detailButton" style={{width:'100%', marginTop:'10px'}} onClick={() => {this.handleClickDetail(item.DATA.CONTENT.TEXT_DUA.DETAIL, item.DATA.SOURCE_ID, true)}}> Detail </Button>					
					 	: null 
					}
					...
					<FullColumn>
						...
						{/* {this.loadMoreButton()} */}
							...
							<div>
								...
								<div style={{ marginBottom: 10, paddingBottom:10, paddingTop:10, borderBottom: "2px dotted #ececec", height:'150px', clear: 'both' }}>
								
								<Grid item xs={5} className="other_applications_my_ticket_dialog_button_reopenticket_grid">
								<Typography className="my_approval_leaverequest" style={{ color:'#666666' }}><b>Emp. PT </b></Typography>
								</Grid>
								<Grid item xs={7} className="other_applications_my_ticket_dialog_closeticket_grid">
								<Typography className="my_approval_leaverequest" style={{ color:'#666666' }}><b>: </b>{value['EMP_PT']}</Typography>
								</Grid>

								<Grid item xs={5} className="other_applications_my_ticket_dialog_button_reopenticket_grid">
								<Typography className="my_approval_leaverequest" style={{ color:'#666666' }}><b>Name </b></Typography>
								</Grid>
								<Grid item xs={7} className="other_applications_my_ticket_dialog_closeticket_grid">
								<Typography className="my_approval_leaverequest" style={{ color:'#666666' }}><b>: </b>{value['EMP_NAME']}</Typography>
								</Grid>

								<Grid item xs={5} className="other_applications_my_ticket_dialog_button_reopenticket_grid">
								<Typography className="my_approval_leaverequest" style={{ color:'#666666' }}><b>Emp. Number : </b></Typography>
								</Grid>
								<Grid item xs={7} className="other_applications_my_ticket_dialog_closeticket_grid">
								<Typography className="my_approval_leaverequest" style={{ color:'#666666' }}><b>: </b>{value['EMP_NO']}</Typography>
								</Grid>

								<Grid item xs={5} className="other_applications_my_ticket_dialog_button_reopenticket_grid">
								<Typography className="my_approval_leaverequest" style={{ color:'#666666' }}><b>OT Plan Date Time Start </b></Typography>
								</Grid>
								<Grid item xs={7} className="other_applications_my_ticket_dialog_closeticket_grid">
								<Typography className="my_approval_leaverequest" style={{ color:'#666666' }}>: {value['OT_PLAN_DATE_TIME_START']}</Typography>
								</Grid>
								
								<Grid item xs={5} className="other_applications_my_ticket_dialog_button_reopenticket_grid">
								<Typography className="my_approval_leaverequest" style={{ color:'#666666' }}><b>OT Plan Date Time End </b> </Typography>
								</Grid>
								<Grid item xs={7} className="other_applications_my_ticket_dialog_closeticket_grid">
								<Typography className="my_approval_leaverequest" style={{ color:'#666666' }}>: {value['OT_PLAN_DATE_TIME_END']}</Typography>
								</Grid>								
								
								<Grid item xs={5} className="other_applications_my_ticket_dialog_button_reopenticket_grid">
								<Typography className="my_approval_leaverequest" style={{ color:'#666666' }}><b>OT Plan Time </b></Typography>
								</Grid>
								<Grid item xs={7} className="other_applications_my_ticket_dialog_closeticket_grid">
								<Typography className="my_approval_leaverequest" style={{ color:'#666666' }}>: {value['OT_PLAN_TIME']}</Typography>
								</Grid>	
								
								<Grid item xs={5} className="other_applications_my_ticket_dialog_button_reopenticket_grid">
								<Typography className="my_approval_leaverequest" style={{ color:'#666666' }}><b>Reason: </b></Typography>
								</Grid>
								<Grid item xs={7} className="other_applications_my_ticket_dialog_closeticket_grid">
								<Typography className="my_approval_leaverequest" style={{ color:'#666666' }}>: {value['REASON']}</Typography>
								</Grid>	
...
export default compose(connect(
	state => ({
	  data:state.SpklapprovalRequest
	}),
	{SPKLAPPROVAL_LIST_REQUEST, SPKLAPPROVAL_LIST_BUTTONAPPROVAL_REQUEST}
