...
import CarouselNew from 'nuka-carousel';
...
class DemoCarousel extends Component {
    ...
    handleClickOpen = (params) => {
      ...
      let paramIdBerita = Base64.encode("dexan-headline-news/"+params.POST_ID);

      this.props.history.push({
        pathname: "/dashboard/detail-news/dexan-headline-news/"+paramIdBerita,
        // state: { 
          ...
          <Carousel
...

                {
                  (typeof slides !== "undefined") ?
                    ...
                    <div
                      ...
                      >
                    <img src={article.DETAIL_PICTURE} 
            ...
            >
              ...
              <div className="dashboard_detail_page_img">
                  <img className={'dashboard_detail_page_img'} src={(typeof detailLifes === "object") ? detailLifes.DETAIL_PICTURE : vegetables} alt="Logo" />
              </div>
